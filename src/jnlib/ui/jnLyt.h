...
static inline u16 jn_ui_getBnllElementCount(const jnui_bnll_res_t* bnll) //I hope this goes here - Roco
{
    return bnll->header.nrElements;
}

static inline const jnui_bncl_res_element_t* jnui_getBnclElement2(const jnui_bncl_res_t* bncl, int idx)
{
